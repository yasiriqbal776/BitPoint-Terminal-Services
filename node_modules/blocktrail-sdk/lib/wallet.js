...
Wallet.prototype.buildTransaction = function(pay, changeAddress, allowZeroConf, randomizeChangeIdx, feeStrategy, options, cb) {
    ...
    q.nextTick(function() {
        ...
        Object.keys(pay).forEach(function(address) {
            ...
            console.log("WALLET>JS Address "+address);
            console.log("WALLET>JS PAY Address "+pay[address]);
            var err = null;
            ...
            try {
                ...
                console.log("WALLET>JS ADDR "+addr);
            } catch (_err) {
                console.log("Error JS WALLET "+_err);
                err = _err;
            }

            if (!addr || err) {
                console.log("Error in address validation is "+err);
